 ...
 * 
 * @property int $id
 * @property string $rekap_rusak_detail_id
 * @property string $rekap_rusak_detail_rekap_rusak_code
 * @property string $rekap_rusak_detail_gudang_code
...
class RekapRusakDetail extends Model
{
	...
	protected $casts = [
		...
		'rekap_rusak_detail_created_at' => 'datetime',
		'rekap_rusak_detail_updated_at' => 'datetime',
		'rekap_rusak_detail_deleted_at' => 'datetime'
	];

	protected $fillable = [
		'rekap_rusak_detail_id',
		'rekap_rusak_detail_rekap_rusak_code',
		'rekap_rusak_detail_gudang_code',
