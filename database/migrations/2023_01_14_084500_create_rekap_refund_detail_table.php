...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rekap_refund_detail', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('r_r_detail_m_produk_id');
            $table->string('r_r_detail_m_produk_code')->nullable();
            $table->string('r_r_detail_m_produk_nama')->nullable();
            $table->decimal('r_r_detail_reguler_price', 8,2)->default(0);
            ...
            $table->string('r_r_detail_status_sync', 20)->default('send');
            $table->unsignedBigInteger('r_r_detail_approved_by')->nullable();
