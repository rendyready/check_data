...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('config_sub_jenis_produk', function (Blueprint $table) {
            $table->id('id');
            $table->unsignedBigInteger('config_sub_jenis_produk_id');
            $table->unsignedBigInteger('config_sub_jenis_produk_m_produk_id');
            $table->unsignedBigInteger('config_sub_jenis_produk_m_sub_jenis_produk_id');
