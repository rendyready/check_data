...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rekap_modal', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('rekap_modal_m_w_id');
            $table->string('rekap_modal_m_w_code')->nullable();
            $table->string('rekap_modal_m_w_nama')->nullable();
            $table->unsignedBigInteger('rekap_modal_m_area_id')->nullable();
            $table->string('rekap_modal_m_area_code')->nullable();
            ...
            $table->decimal('rekap_modal_cash_in', 15,2)->default(0);
            $table->decimal('rekap_modal_cash_out', 15,2)->default(0);
            $table->decimal('rekap_modal_cash', 15,2)->default(0);
            $table->decimal('rekap_modal_cash_real', 15,2)->default(0);
            $table->string('rekap_modal_status')->default('open');
            $table->string('rekap_modal_keterangan')->nullable();
            $table->string('rekap_modal_status_sync', 20)->default('send');
