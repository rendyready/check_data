...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('tmp_transaction_detail', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tmp_transaction_detail_m_produk_id')->nullable();
            ...
            $table->decimal('tmp_transaction_detail_tax_val', 5,2)->default(0);
            $table->decimal('tmp_transaction_detail_service_val', 5,2)->default(0);
            ...
            $table->string('tmp_transaction_detail_discount_type')
            ->comment('Persen,Nominal,Qty,CustomPrice,NormalPrice')
            ->default('NormalPrice');
        });
    }
