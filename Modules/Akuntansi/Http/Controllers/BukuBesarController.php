...
class BukuBesarController extends Controller
{
    ...
    public function index()
    {
        ...
        $data->rekening = DB::table('m_rekening')
            ->join('m_link_akuntansi', 'm_link_akuntansi_m_rekening_no_akun', 'm_rekening_no_akun')
            ->select('m_rekening_nama', 'm_rekening_no_akun', DB::raw('MAX(m_link_akuntansi_nama) as m_link_akuntansi_nama'))
    ...
    public function tampil_buku_besar(Request $request)
    {
        // return $request->akun;
        ...
        foreach ($kas_transaksi as $kasTrans) {
            ...
            if ($request->akun == 'Pajak Transaksi') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Service Charge Transaksi') {
                $processed_ids = array();
                foreach ($sc as $valsc) {
                    $common_id = $kasTrans->r_t_id;
                    if (!in_array($common_id, $processed_ids)) {
            ...
            if ($request->akun == 'Tarik Tunai Transaksi') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Pembulatan Transaksi') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Free Kembalian Transaksi') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Diskon Transaksi') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Persediaan Transaksi') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Biaya Persediaan Transaksi') {
                $processed_ids = array();
        ...
        foreach ($refund as $valRefund) {
            ...
            if ($request->akun == 'Nominal Refund') {
                $processed_ids_ref = array();
            ...
            if ($request->akun == 'Service Charge Refund') {
                $processed_ids_ref = array();
            ...
            if ($request->akun == 'Pembulatan Refund') {
                $processed_ids_ref = array();
            ...
            if ($request->akun == 'Free Kembalian Refund') {
                $processed_ids_ref = array();
            ...
            if ($request->akun == 'Persediaan Refund') {
                $processed_ids_ref = array();
            ...
            if ($request->akun == 'Biaya Persediaan Refund') {
                $processed_ids_ref = array();
        ...
        foreach ($lostbill as $valLostbill) {
            if ($request->akun == 'Persediaan Lostbill') {
                $processed_ids = array();
            ...
            if ($request->akun == 'Biaya Persediaan Lostbill') {
                $processed_ids = array();
        ...
        foreach ($garansi as $valGaransi) {
            if ($request->akun == 'Persediaan Garansi') {
            ...
            if ($request->akun == 'Biaya Persediaan Garansi') {
                $processed_ids_gar = array();
