                                ...
                                <div class="row mb-2 col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="filter-waroeng" style="width: 100%;"
                                            class="cari js-select2 form-control" name="r_j_k_m_w_id">
                                ...
                                <div class="row mb-2 col-6">
                                    ...
                                    <div class="col-md-8">
                                        <select id="filter-kas" class="cari js-select2 form-control kas-click"
                                            style="width: 100%;" name="r_j_k_status">
                                ...
                                <div class="row mb-2 col-6">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?= date('Y-m-d') ?>" id="filter-tanggal"
                                            class="cari form-control " style="width: 100%;" name="r_j_k_tanggal"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" placeholder="Input Nomor Akun"
                                                        id="r_j_k_m_rekening_code" name="r_j_k_m_rekening_code[]"
                                                        class="form-control set form-control-sm no-akun text-center" />
                                                </td>
                                                <td>
                                                    <select id="m_rekening_nama" name="r_j_k_m_rekening_nama[]"
                                                        data-placeholder="Pilih Nama Rekening"
                                                        class="js-select2 set_select showrek" style="width:200px;">
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" placeholder="Input Particul" id="r_j_k_particul"
                                                        name="r_j_k_particul[]"
                                                ...
                                                <td>
                                                    <div class="saldo_debit">
                                                        <input type="text" placeholder="Input Saldo Debit"
                                                            id="r_j_k_debit" name="r_j_k_debit[]"
                                                    ...
                                                    <div class="saldo_kredit">
                                                        <input type="text" placeholder="Input Saldo Kredit"
                                                            id="r_j_k_kredit" name="r_j_k_kredit[]"
                                                            class="form-control set form-control-sm saldo text-end number" />
                                                    </div>
                                                </td>
                                                <td>
        ...
        $(document).ready(function() {
            ...
            $('.tambah').on('click', function() {
                ...
                $('#form').append('<tr class="hapus" id="' + no + '">' +
                    ...
                    '" style="width:200px;" class="js-select2 item_produkjq" name="r_j_k_m_rekening_item[]"></select></td>' +

                    '<td><input type="text" placeholder="Input Nomor Akun" id="r_j_k_m_rekening_codejq' +
                    no +
                    '" name="r_j_k_m_rekening_code[]" class="form-control form-control-sm no_akunjq text-center"/></td>' +
                    '<td><select data-placeholder="Pilih Nama Rekening" id="m_rekening_namajq' + no +
                    '" style="width:200px;" class="js-select2 showrekjq" name="r_j_k_m_rekening_nama[]"></select></td>' +
                    '<td><input type="text" class="form-control form-control-sm text-center" name="r_j_k_particul[]" id="r_j_k_particul" placeholder="Input Particul"></td>' +
                    '<td><div class="saldo_debit"><input type="text" class="form-control form-control-sm saldo text-end number" name="r_j_k_debit[]" id="r_j_k_debitjq' +
                    no + '" placeholder="Input Saldo Debit"></div>' +
                    '<div class="saldo_kredit"><input type="text" class="form-control form-control-sm saldo text-end number" name="r_j_k_kredit[]" id="r_j_k_kreditjq' +
            ...
            $('#jurnal-tampil').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            return data.r_j_k_m_rekening_nama + ' ' + data
                                .r_j_k_m_w_nama;
                        }
                    },
                    {
            ...
            $('.cari').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('jurnal_kas.list_item') }}',
                    type: 'GET',
                    dataType: 'Json',
                    data: {
                        filwaroeng: filwaroeng,
            ...
            $(document).on('keyup', '.no_akunjq', function() {
                var id = $(this).closest("tr").attr("id");
                var filnomor2 = $('#r_j_k_m_rekening_codejq' + id).val();
                $.ajax({
                    type: "get",
                    url: '{{ route('jurnal.carijurnalnoakun') }}',
                    data: {
