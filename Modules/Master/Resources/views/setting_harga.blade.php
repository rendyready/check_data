...
@section('content')
      ...
      <div class="col-md-12 col-xl-12">
        <div class="block block-themed h-100 mb-0">
          ...
          <div class="block-content text-muted">
            <a class="btn btn-success mr-5 mb-5 buttonInsert" value="" title="Edit" style="color: #fff"><i class="fa fa-plus mr-5"></i> Harga Nota</a>
            <a class="btn btn-info mr-5 mb-5 buttonCopy" value="" title="copy" style="color: #fff"><i class="fa fa-copy mr-5"></i> Copy Nota</a>
            <a class="btn btn-warning mr-5 mb-5 buttonUpdate" value="" title="update" style="color: #fff"><i class="fa fa-refresh mr-5"></i> Update Harga</a>
            @csrf
              ...
              <tbody id="tablecontents">
                @foreach ($data as $item)
                    <tr>
                      ...
                      <td> <a class="btn btn-info buttonEdit" value="{{$item->m_jenis_nota_id}}" title="Edit"><i class="fa fa-edit"></i></a>
            ...
            <form method="post" action="" id="formAction">
              ...
              <div class="mb-4">
                <div class="form-group">
                  ...
                  <div>
                      <select class="js-select2" id="m_jenis_nota_m_w_id" name="m_jenis_nota_m_w_id" style="width: 100%;" data-container="#modal-block-select2" data-placeholder="Choose one..">
                          <option></option>
              ...
              <div class="mb-4">
                <div class="form-group">
                  ...
                  <div>
                      <select class="js-select2" id="m_jenis_nota_m_t_t_id" name="m_jenis_nota_m_t_t_id" style="width: 100%;" data-container="#modal-block-select2" data-placeholder="Choose one..">
                          <option></option>
            ...
            <form method="post" action="" id="formAction2">
              ...
              <div class="mb-4">
                <div class="form-group">
                  ...
                  <div>
                      <select class="js-select2" id="m_jenis_nota_trans_id" name="m_jenis_nota_trans_id" style="width: 100%;" data-container="#copy_nota" data-placeholder="Choose one..">
                          <option></option>
              ...
              <div class="mb-4">
                <div class="form-group">
                  ...
                  <div>
                      <select class="js-select2" id="m_jenis_nota_waroeng_sumber_id" name="m_jenis_nota_waroeng_sumber_id" style="width: 100%;" data-container="#copy_nota" data-placeholder="Choose one..">
                          <option></option>
                          @foreach ($listWaroeng as $wr)
                              <option value="{{$wr->m_w_id}}">{{ ucwords($wr->m_w_nama)}}</option>
                          @endforeach
              ...
              <div class="mb-4">
                <div class="form-group">
                  ...
                  <div>
                      <select class="js-select2" id="m_jenis_nota_waroeng_tujuan_id" name="m_jenis_nota_waroeng_tujuan_id" style="width: 100%;" data-container="#copy_nota" data-placeholder="Choose one..">
                          <option></option>
                          @foreach ($listWaroeng as $wr)
                              <option value="{{$wr->m_w_id}}">{{ ucwords($wr->m_w_nama)}}</option>
                          @endforeach
  ...
  <!-- END Select2 in a modal copy nota-->
   ...
   <div class="modal" id="update_harga" tabindex="-1" role="dialog" aria-labelledby="update_harga" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="block block-themed shadow-none mb-0">
          <div class="block-header block-header-default bg-pulse">
...
<script type="module">
  $(document).ready(function(){
      ...
      $(".buttonUpdate").on('click', function() {
            $("#myModalLabel3").html('Copy Harga Nota');
            $("#formAction3").attr('action',"/master/m_jenis_nota/copy");
            $("#copy_nota").modal('show');
      });
