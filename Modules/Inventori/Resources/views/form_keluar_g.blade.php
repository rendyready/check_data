                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control form-control-sm" id="rekap_tf_g_detail_code"
                                                name="rekap_tf_code" value="{{ $data->code }}" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-1">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="row mb-1">
                                        <label class="col-sm-4 col-form-label" for="rekap_tf_gudang_asal_id">Gudang Asal</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="row mb-1">
                                        <label class="col-sm-4 col-form-label" for="rekap_tf_gudang_tujuan_id">Gudang Tujuan</label>
                                        <div class="col-sm-8">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" step="0.01"
                                                    ...
                                                    name="rekap_tf_g_detail_qty_kirim[]" maxlength="9" max="100" id="rekap_tf_g_detail_qty_kirim1" required>
                                            </td>
                                            <td><input type="number" class="form-control number form-control-sm harga"
                                                    name="rekap_tf_g_detail_hpp[]" id="rekap_tf_g_detail_hpp1"
                                                    readonly></td>
