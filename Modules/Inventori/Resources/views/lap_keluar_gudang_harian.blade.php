...
<div class="content">
    <div class="row items-push">
      <div class="col-md-12 col-xl-12">
        <div class="block block-themed h-100 mb-0">
          <div class="block-header bg-pulse">
            <h3 class="block-title">
              Rekap Keluar & Terima Bahan Baku Harian
            </h3>
              </div>
        ...
        <div id="tampil_opr">
            <table id="tampil_rekap_opr" class="table table-sm table-bordered table-hover table-striped table-vcenter js-dataTable-full nowrap">
              <thead>
                <tr>
                    <th class="text-center">Area</th>
                    <th class="text-center">Waroeng</th>
...
$(document).ready(function() {
    ...
    $('#cari').on('click', function() {
        ...
        if(show_pengadaan == 'ya'){
            ...
            pageLength: 10,
            ajax: {
                url: '{{route("lap_gudang_harian.tampil_harian")}}',
                data : {
                    area: area,
                    waroeng: waroeng,
                    tanggal: tanggal,
    ...
    if(HakAksesPusat){
      $('.filter_area').on('select2:select', function(){
        ...
        if(id_area && tanggal){
            $.ajax({
            type:"GET",
            url: '{{route("lap_gudang_harian.select_waroeng_harian")}}',
            dataType: 'JSON',
            destroy: true,    
            data : {
                id_area: id_area,
