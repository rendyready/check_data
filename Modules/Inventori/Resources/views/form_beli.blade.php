          ...
          <div class="block-content text-muted">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-7">
                              <input type="date" class="form-control form-control-sm" value="{{$data->tgl_now}}" id="rekap_beli_jth_tmp" name="rekap_beli_jth_tmp" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                ...
                <table id="form" class="table table-sm table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                        ...
                        <td><input type="number" class="form-control form-control-sm harga" name="rekap_beli_detail_harga[]" id="rekap_beli_detail_harga" required></td>
                        <td><input type="number" class="form-control form-control-sm persendisc" name="rekap_beli_detail_disc[]" id="rekap_beli_detail_disc"></td>
                        <td><input type="number" class="form-control form-control-sm rupiahdisc" name="rekap_beli_detail_discrp[]" id="rekap_beli_detail_discrp"></td>
  ...
  $.ajaxSetup({
    ...
    $.get('/inventori/beli/list', function(response){
	  ...
	  $('.tambah').on('click',function(){
        ...
        $('#form').on('click','.tambah, .btn_remove', function(){
          Codebase.helpersOnLoad(['jq-select2']);
        ...
        $('#form').on('select2:open','#rekap_beli_detail_m_produk_id'+no,function (e) {
         var id = $(this).val();
          var val_id = $('[name="rekap_beli_detail_m_produk_id[]"]').map(function () {
                return this.value; // $(this).val()
          }).get();
          $('option, #rekap_beli_detail_m_produk_id'+no).prop('disabled',false);
          if (id != null) {
