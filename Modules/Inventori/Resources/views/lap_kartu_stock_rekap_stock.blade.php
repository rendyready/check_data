                        ...
                        <form id="rekap_insert">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label"
                                            for="rekap_inv_penjualan_created_by">Gudang</label>
                                        <div class="col-sm-9">
                                            @if (!in_array(Auth::user()->waroeng_id, $data->akses_area))
                                                <select id="filter_gudang1" data-placeholder="Pilih Gudang"
                                                    style="width: 100%;"
                                                    class="cari f-area js-select2 form-control filter_gudang"
                                                    name="m_w_m_area_id">
                                                    <option></option>
                                                    @foreach ($data->gudang as $gudang)
                                                        <option value="{{ $gudang->m_gudang_code }}">
                                                            {{ $gudang->m_gudang_nama }} </option>
                                                    @endforeach
                                                    <option value="all">Gudang Utama dan Produksi</option>
                                                </select>
                                            @else
                                                <select id="filter_gudang2" style="width: 100%;"
                                                    class="cari f-wrg js-select2 form-control filter_gudang"
                                                    data-placeholder="Pilih Gudang" name="m_stok_gudang_code">
                                                    <option></option>
                                                </select>
                                            @endif
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label"
                                            for="rekap_inv_penjualan_created_by">Klasifikasi</label>
                                        <div class="col-sm-9">
                                            <select id="filter_bb" data-placeholder="Pilih Klasifikasi BB"
                                                style="width: 100%;" class="cari f-area js-select2 form-control filter_bb"
                                                name="m_w_m_area_id">
                                                <option></option>
                                                @foreach ($data->bb as $bb)
                                                    <option value="{{ $bb->m_klasifikasi_produk_id }}">
                                                        {{ $bb->m_klasifikasi_produk_nama }} </option>
                                                @endforeach
                                                <option value="all">All Klasifikasi BB</option>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
