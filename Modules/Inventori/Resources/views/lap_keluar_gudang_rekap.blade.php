...
<div class="content">
    <div class="row items-push">
      <div class="col-md-12 col-xl-12">
                            ...
                            <div class="col-md-5">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        class="cari f-wrg js-select2 form-control" data-placeholder="Pilih Status" name="rekap_beli_created_by">
                                        <option></option>
        ...
        <div id="asal">
            <table id="tampil_rekap_asal" class="table table-sm table-bordered table-striped table-vcenter nowrap table-hover js-dataTable-full">
              <thead>
                <tr>
              ...
              <tbody id="show_data_asal">
              </tbody>
            </table>
        </div>
        <div id="tujuan">
            <table id="tampil_rekap_tujuan" class="table table-sm table-bordered table-striped table-vcenter nowrap table-hover js-dataTable-full">
                <thead>
                  <tr>
                    <th class="text-center">Tanggal</th>
                    <th class="text-center">Kode</th>
