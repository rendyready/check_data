                ...
                <div class="block block-themed h-100 mb-0">
                    ...
                    <div class="block-content text-muted">
                        <a class="btn btn-success mr-2 mb-2 buttonInsert" title="Edit" style="color: #fff"><i
                                class="fa fa-plus mr-5"></i> Gudang</a>
                        <table id="tb_gudang"
                        ...
                        <!-- Select2 in a modal -->
                        <div class="modal" id="form-gudang" tabindex="-1" role="dialog" aria-labelledby="form-gudang"
                            aria-hidden="true">
                                            ...
                                            <form method="post" id="formAction">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <select class="js-select2" id="m_gudang_nama"
                                                                name="m_gudang_nama" style="width: 100%;"
                                                                data-container="#form-gudang"
                                                                data-placeholder="Pilih Nama Gudang">
                                                                <option></option>
                                                                @foreach ($nama_gudang as $item)
                                                                    <option value="{{ ucwords($item->m_gudang_nama) }}">
                                                ...
                                                <div class="mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <select class="js-select2" id="m_gudang_m_w_id"
                                                                name="m_gudang_m_w_id" style="width: 100%;"
                                                                data-container="#form-gudang"
