...
$(document).ready(function() {
    ...
    // var currentPage = 1; // Inisialisasi halaman saat ini
    ...
    //             sesi: sesi,
    //             status: status,
    //             page: page, // Tambahkan parameter halaman dalam permintaan Ajax
    //             length: $('#tampil_rekap').DataTable().page.len(), // Gunakan nilai pageLength dari DataTable
    //         },
    //         success: function (res) {
    //             if (res.type != 'error') {
    //                 // Hapus dan reinisialisasi DataTable dengan data baru
    //                 $('#tampil_rekap').DataTable().destroy(); // Hapus DataTable sebelum reinisialisasi
    //                 $('#tampil_rekap').DataTable({
    //                     // Opsi DataTable lainnya
    //                     data: res.data, // Set data dari respons Ajax
    //                     pageLength: pageLength, // Set jumlah data per halaman berdasarkan opsi DataTable
    //                 });

    //                 // Update halaman saat ini dengan nilai yang diterima dari server
    //                 currentPage = res.current_page;

    //                 // Tampilkan tombol "Next" hanya jika halaman saat ini kurang dari total halaman
    ...
    //     $('#tampil_rekap').on('click', '.paginate_button', function () {
    //         var page = $(this).attr('data-dt-idx'); // Mendapatkan nomor halaman dari atribut data
    //         loadData(page); // Muat data untuk halaman yang dipilih
    //     });
