                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="tmp_tanggal_date" class="cari form-control filter_tanggal" type="text" placeholder="Pilih Tanggal.." id="filter_tanggal" />
                                    </div>
                                </div>
                            </div>
                        </div> 
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="filter_sif" style="width: 100%;"
                                            class="cari f-wrg js-select2 form-control filter_sif" data-placeholder="Pilih Sesi" name="sif[]">
                                            <option></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="filter_trans" style="width: 100%;"
                                            class="cari f-wrg js-select2 form-control filter_trans" data-placeholder="Pilih Tipe Transaksi" name="tipe_trans[]">
                                            <option></option>
                                        </select>
                                    </div>
                                </div>
