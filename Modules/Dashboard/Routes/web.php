...
Route::prefix('dashboard')->middleware('auth', 'web')
    ->group(function () {
        ...
        Route::controller(LaporanKasHarianKasirController::class)->group(function () {
            ...
            Route::match(['get', 'post'], 'kas_kasir/export_pdf/{id}/{tanggal}/{waroeng}', 'export_pdf')->name('kas_kasir.export_pdf');
            ...
            // Route::get('kas_kasir/kronologi', 'kronologi')->name('kas_kasir.kronologi');
        });
